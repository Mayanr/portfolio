        ...
        <Fragment>
            <div className="sidebar"  >
                ...
                <ul id="myLinks">
                    ...
                    <li style={{marginBottom: 10+"px"}}><a id="cv" href={require("../media/myMedia/mrothstein_visual_resume.pdf")} className="social_links" target="_blank" rel="noopener noreferrer" title="Link to my resume"><img id="GH_logo"  alt="my resume" src={require("../media/icons/cv.png")} height="30" /></a></li>
                    ...
                    <li><a id="email" href="mailto:mayan@bu.edu" className="social_links" target="_blank" rel="noopener noreferrer" title="Link that opens an email address to me"><img id="mail_logo" alt="mayam@bu.edu" src={require("../media/icons/email.png")} height="20"/></a></li>
