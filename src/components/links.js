    ...
    return (
            <div className="sidebar" id="myLinks" >
                ...
                <ul>
                    ...
                    <li><a id="email" href="mailto:mayan@bu.edu" className="social_links" target="_blank" rel="noopener noreferrer"><img id="mail_logo" alt="mayam@bu.edu" src={require("../media/icons/email.png")} height="30"/></a></li>

                    <li><a id="instagram" href="https://www.instagram.com/mayanrothstein/" className="social_links" target="_blank" rel="noopener noreferrer"><img id="IG_logo" alt="https://www.instagram.com/mayanrothstein/" src={require("../media/icons/ig.png")} height="30"/></a></li>
