            ...
            <h2>Professional Experience</h2> 
             <div id="resumeTable">
                <ul id="companySelection">
                    <li onClick={e =>displayTM()} id="TM_logo" className="clickedCompany" tabindex="0"><img   alt="Ticketmaster Logo" src={require("../media/company_logos/tm.png")} height="20" title="Ticketmaster" /></li>

                    <li onClick={e =>displayRS()} id="RS_logo" className="clickedCompany" tabindex="0"><img   alt="Riversand Logo" src={require("../media/company_logos/riversand.png")} height="25" title="Riversand Technologies" /></li>
